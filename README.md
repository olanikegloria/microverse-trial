...
```sh
  cd my-folder
  git clone git@github.com:olanikegloria/microverse-trial.git
```
...
- GitHub: [ALfuhidy](https://github.com/olanikegloria)
...
-I would like to thank ALfuhidy for letting me use his microverse trial project
